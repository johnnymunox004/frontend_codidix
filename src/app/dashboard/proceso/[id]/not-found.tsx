  ...
  return (
    <DashboardLayout>
      <div className="bg-red-50 border border-red-200 text-red-700 px-4 py-6 rounded-lg mb-6 flex flex-col items-center text-center">
        ...
        <h2 className="text-xl font-semibold text-red-800 mb-2">Proceso no encontrado</h2>
        <p className="text-red-700 mb-4">
          No se encontró el proceso judicial solicitado. Verifique el número de proceso e intente nuevamente.
        </p>
        <Link 
